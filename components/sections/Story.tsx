...
export const Story: React.FC = () => {
  return (
    <section className="stage min-h-screen bg-gradient-to-br from-[#d91b1b0d] to-[#d91b1b05] texture-overlay scroll-snap-align-start flex flex-col justify-center py-20" id="about">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full">
        <div className="flex flex-col md:flex-row items-center gap-12 lg:gap-20">
          <div className="md:w-1/2">
            ...
            <h2 className="font-display text-4xl md:text-6xl font-black mb-8 leading-[1.1] uppercase tracking-tighter text-charcoal">
              Local Roots,<br/><span className="text-brand-red">Global Perspective</span>
            </h2>
            <div className="space-y-6 text-muted-gray leading-relaxed text-base font-bold">
              <p>Miles is an Australian-born Vietnamese and Tam being the other is a true Hanoian. Together, we bring over 12 years of experience designing travel in Vietnam. English-speaking and locally based, we create journeys we would confidently recommend to friends and family, balancing authentic experiences with comfort, clarity, and careful planning from start to finish.</p>
            </div>
        ...
        <div className="mt-12 flex justify-center md:justify-start gap-4">
          ...
          <button 
             ...
             className="bg-charcoal text-white px-10 py-4 rounded-full font-black text-xs uppercase tracking-[0.2em] shadow-xl"
          >
            See Stories ➔
          </button>
        </div>

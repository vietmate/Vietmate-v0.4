...
export const Hero: React.FC = () => {
  return (
    <header className="stage min-h-screen bg-[#F9F9F9] scroll-snap-align-start flex flex-col justify-center relative overflow-hidden" id="hero">
        ...
        <h1 className="font-display text-5xl md:text-8xl lg:text-9xl text-charcoal font-extrabold mb-8 tracking-tighter uppercase leading-none flex flex-wrap justify-center items-center">
          <span className="flex items-center">
            ...
            <span className="flex items-center justify-center ml-4 md:ml-6 lg:ml-8 leading-none">
              <svg className="h-[0.72em] w-auto aspect-[3/2] block rounded shadow-lg" viewBox="0 0 900 600" xmlns="http://www.w3.org/2000/svg">
      ...
      <button 
        onClick={() => document.getElementById('why')?.scrollIntoView({ behavior: 'smooth' })}
        className="absolute bottom-10 left-1/2 -translate-x-1/2 flex flex-col items-center gap-2 text-charcoal/40"
      >
